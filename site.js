(() => {
  ...
  function setLanguage(lang) {
    ...
    document.querySelector('meta[name="description"]').content = lang === 'en'
      ? '2026 International Conference on AI for Engineering, Workshop Call for Papers. Submit papers by 10 October; acceptance notifications on 15 October; presentation in poster format and awards on 1 November.'
      : '2026国际工程智能大会Workshop论文征集，入选论文以Poster形式展示。10月10日投稿截止，10月15日通知入选，11月1日现场展示与颁奖。';
